...
cnx = mysql.connector.connect(user='root', password='sameed',
                              host='127.0.0.1',
...
g.parse("/home/sameed/PycharmProjects/CrunchBasedPlayGround/SqlConnecter/ipos.nt", format="nt")
