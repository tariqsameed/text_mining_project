...
def posTagging():
    ...
    english_postagger = StanfordPOSTagger(
        '/home/sameed/Masters-Passau/stanford-postagger-full-2016-10-31/models/english-bidirectional-distsim.tagger',
        '/home/sameed/Masters-Passau/stanford-postagger-full-2016-10-31/stanford-postagger.jar')
...
def NER():
    ...
    st = StanfordNERTagger(
        '/home/sameed/Masters-Passau/stanford-ner-2016-10-31/classifiers/english.all.3class.distsim.crf.ser.gz',
