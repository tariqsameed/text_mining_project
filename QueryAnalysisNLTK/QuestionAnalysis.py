...
#model = gensim.models.Word2Vec.load_word2vec_format('/home/sameed/Masters-Passau/GoogleNews-vectors-negative300.bin',binary=True)
#model.init_sims(replace=True)


standfordTagger = StanfordNERTagger(
      '/home/sameed/Masters-Passau/stanford-ner-2016-10-31/classifiers/english.muc.7class.distsim.crf.ser.gz',
      '/home/sameed/Masters-Passau/stanford-ner-2016-10-31/stanford-ner.jar')


path_to_jar = '/home/sameed/Masters-Passau/stanford-parser-full-2016-10-31/stanford-parser.jar'
path_to_models_jar = '/home/sameed/Masters-Passau/stanford-parser-full-2016-10-31/stanford-parser-3.7.0-models.jar'
...
def gensimAnalysis():
    ...
    model = gensim.models.Word2Vec.load_word2vec_format(
        '/home/sameed/Masters-Passau/GoogleNews-vectors-negative300.bin', binary=True)
    model.init_sims(replace=True)
