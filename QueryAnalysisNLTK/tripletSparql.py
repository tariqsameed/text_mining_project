...
def fetch_peoples(input_full_name):
    ...
    # People.nt
    g.parse("/home/sameed/PycharmProjects/CrunchBasedPlayGround/SqlConnecter/people.nt", format="nt")
...
def fetch_relationship_org(input_full_Org , gen_word):
    ...
    # People.nt
    g.parse("/home/sameed/PycharmProjects/CrunchBasedPlayGround/SqlConnecter/relationships.nt", format="nt")
...
def fetch_graduates(input_university , input_year, gen_word):
    ...
    university_list = []
    # Degrees.nt
    g.parse("/home/sameed/PycharmProjects/CrunchBasedPlayGround/SqlConnecter/degrees.nt", format="nt")
